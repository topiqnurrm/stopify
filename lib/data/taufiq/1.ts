...
export const taufiq1: MusicItem[] = [
    {
        id: 100,
    ...
    {
        id: 99,
        judul: "Here’s Your Perfect, Jamie Miller",
        link: "https://www.youtube.com/watch?v=7CsoxVymuPY",
        tahun: "2021 April 30",
        playlist : [
            "b",
            "3", "h", "4", "8", "60", "1",
    ...
    {
        id: 98,
        judul: "Body (Remix) [feat. ArrDee, E1 (3x3), ZT (3x3), Bugzy Malone, Buni, Fivio Foreign & Darkoo],, Tion Wayne, Russ Millions, ArrDee, E1 (3x3), ZT (3x3), Bugzy Malone, Buni, Fivio Foreign, Darkoo",
        link: "https://www.youtube.com/watch?v=1ss-Wbl1bV0",
        tahun: "2021 Maret 25",
        playlist : [
            "b",
            "2", "d", "8", "60",
    ...
    {
        id: 97,
        judul: "Goosebumps - Remix, Travis Scott, HVME",
        link: "https://www.youtube.com/watch?v=6riaOYI9MKo",
    ...
    {
        id: 96,
        judul: "Beautiful Mistakes (feat. Megan Thee Stallion), Maroon 5, Megan Thee Stallion",
        link: "https://www.youtube.com/watch?v=qrztilBlLEE",
        tahun: "2021 Maret 3",
        playlist : [
            "b",
            "2", "h", "5", "8", "60",
    ...
    {
        id: 95,
        judul: "Watermelon Sugar, Harry Styles",
        link: "https://www.youtube.com/watch?v=P6lwcBnQx7g",
        tahun: "2019 November 17",
        playlist : [
            "b",
            "2", "5", "8", "60",
        ],
    ...
    {
        id: 94,
        judul: "First Love- Nikka Costa, Willy Anggawinata",
        link: "https://www.youtube.com/watch?v=_xeUtl9m4GQ",
        tahun: "1999 April 28",
        playlist : [
            "b",
            "3", "h", "1", "7", "60",
    ...
    {
        id: 93,
        judul: "Hot Sauce, NCT DREAM",
        link: "https://www.youtube.com/watch?v=1DRv6zVsQa8",
        tahun: "2021 Mei 10",
        playlist : [
            "b",
            "2", "d", "8", "10",
    ...
    {
        id: 92,
        judul: "Lemon Tree, Fools Garden",
        link: "https://www.youtube.com/watch?v=mSU_rHackSY",
        tahun: "1995 Oktober 1",
        playlist : [
            "b",
            "2", "5", "8", "60",
        ],
    ...
    {
        id: 91,
        judul: "positions, Ariana Grande",
        link: "https://www.youtube.com/watch?v=fUpU4VvDnXY",
        tahun: "2020 Oktober 23",
        playlist : [
            "b",
            "2", "5", "8", "60",
        ],
